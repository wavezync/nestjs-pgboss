...
import { QueueOptions, ScheduleOptions, WorkOptions } from "pg-boss";
...
export function Job(
  ...
  return (target: object, key: string, descriptor: PropertyDescriptor) => {
    ...
    SetMetadata(QUEUE_OPTIONS, queueOptions)(target, key, descriptor);
    SetMetadata(PG_BOSS_JOB_METADATA, {
      jobName: name,
      workOptions: options,
      queueOptions,
